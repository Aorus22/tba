...
const blankSymbol = " "
// const transitions = {
//     '{"state":"q0","symbol":"1"}': { newState: 'q0', writeSymbol: '1', direction: 'R' },
//     '{"state":"q0","symbol":"0"}': { newState: 'q0', writeSymbol: '0', direction: 'R' },
//     '{"state":"q0","symbol":"X"}': { newState: 'q7', writeSymbol: 'X', direction: 'L' },
//     '{"state":"q0","symbol":" "}': { newState: 'q1', writeSymbol: ' ', direction: 'L' },
    
//     '{"state":"q1","symbol":"1"}': { newState: 'q2', writeSymbol: ' ', direction: 'L' },
//     '{"state":"q1","symbol":"0"}': { newState: 'q3', writeSymbol: 'X', direction: 'L' },
    
//     '{"state":"q2","symbol":"0"}': { newState: 'q2', writeSymbol: ' ', direction: 'L' },
    
//     '{"state":"q3","symbol":"1"}': { newState: 'q3', writeSymbol: '1', direction: 'L' },
//     '{"state":"q3","symbol":"0"}': { newState: 'q3', writeSymbol: '0', direction: 'L' },
//     '{"state":"q3","symbol":" "}': { newState: 'q4', writeSymbol: ' ', direction: 'R' },
    
//     '{"state":"q4","symbol":"0"}': { newState: 'q0', writeSymbol: ' ', direction: 'R' },
//     '{"state":"q4","symbol":"1"}': { newState: 'q5', writeSymbol: ' ', direction: 'R' },
    
//     '{"state":"q5","symbol":"Y"}': { newState: 'q5', writeSymbol: '0', direction: 'R' },
//     '{"state":"q5","symbol":"X"}': { newState: 'q5', writeSymbol: ' ', direction: 'R' },
//     '{"state":"q5","symbol":" "}': { newState: 'q6', writeSymbol: ' ', direction: 'R' },
//     '{"state":"q5","symbol":"0"}': { newState: 'q5', writeSymbol: ' ', direction: 'R' },
    
//     '{"state":"q7","symbol":"Y"}': { newState: 'q7', writeSymbol: 'Y', direction: 'L' },
//     '{"state":"q7","symbol":"1"}': { newState: 'q8', writeSymbol: '1', direction: 'R' },
//     '{"state":"q7","symbol":"0"}': { newState: 'q3', writeSymbol: 'X', direction: 'L' },
    
//     '{"state":"q8","symbol":" "}': { newState: 'q7', writeSymbol: 'Y', direction: 'L' },
//     '{"state":"q8","symbol":"Y"}': { newState: 'q8', writeSymbol: 'Y', direction: 'R' },
//     '{"state":"q8","symbol":"X"}': { newState: 'q8', writeSymbol: '0', direction: 'R' },
// }
